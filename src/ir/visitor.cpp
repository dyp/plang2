...
bool Visitor::traverseRecognizerExpr(RecognizerExpr &_expr) {
    ENTER(RecognizerExpr, _expr);
    TRAVERSE(Expression, RecognizerExpression, _expr.getObject(), _expr, Component, setObject);
    EXIT();
}
